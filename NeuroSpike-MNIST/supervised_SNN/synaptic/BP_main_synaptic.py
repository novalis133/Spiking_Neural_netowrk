...
if __name__ == "__main__":
    ...
    # define optimizer
    optimizer = torch.optim.Adamax(Net_Synaptic.parameters(), lr=1e-2, betas=(0.9, 0.999),
                                   eps=1e-07)
    ...
    for i in BP:
        ...
        for epoch in range(epochs):
            ...
            # alterantive change
            avg_loss = i(Net_Synaptic, train_loader, optimizer=optimizer, criterion=loss_fn,
